...
class DiDeMo_DataLoader(Dataset):
    def __init__(
        ...
        # video_ids = list(set(video_ids) & set(self.caption_dict.keys()) & set(self.video_dict.keys()))  # used in CLIP4CLIP
    ...
    def _get_rawvideo(self, idx, s, e):
        ...
        # Pair x L x T x 3 x H x W (Pair: num_clips, L: num_frames, T=1)
        ...
        try:
            for i in range(len(s)):
                ...
                if len(raw_video_data.shape) > 3:
                    ...
                    # L x T x 3 x H x W (L: real num_frames, T=1)
