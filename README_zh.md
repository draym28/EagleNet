...
论文链接：[[arXiv]](https://arxiv.org/abs/2603.25267v3)。
...
此外，原始/压缩视频可通过 [Baidu Netdisk](https://pan.baidu.com/s/1OlrADWgLE9fWUdieB0JX_Q?pwd=qasj) 下载。

划分/标注文件可以通过 [Google Drive](https://drive.google.com/drive/folders/1nqJfU2dYYJYNcT6X1yBCkhnj6Z0j4zHw) 或 [Baidu Netdisk](https://pan.baidu.com/s/1a6HoHzwp3UFJPhA3_Pk5Zg?pwd=ckch) 下载。
...
MSRVTT（ViT-B/32 & ViT-B/16）的 EagleNet 模型文件可以通过 [Google Drive](https://drive.google.com/drive/folders/1oy8nvyd6tbUqGVJZ44layuyaHSXcyQeP) 或 [Baidu Netdisk](https://pan.baidu.com/s/1Ps9iRkKOR9V8yQklGalY5Q?pwd=rief) 下载，然后运行：
