...
ANNO_PATH=$PWD/../_data/origin/MSRVTT/msrvtt_data/
VID_PATH=$PWD/../_data/origin/MSRVTT/videos/all/
...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES python main_my.py \
    ...
    --output_dir $BEST_CKPT_FOLDER/eval-msrvtt9k-vit_b_32/ --datatype msrvtt9k --expand_msrvtt_sentences 1 \
    ...
    --loss_fn sig --framepe 0 --energy_fn mlp --energy_pooling avg \
    --best_ckpt_path $BEST_CKPT_FOLDER/msrvtt9k-vit_b_32.bin
